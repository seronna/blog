 ...
 */
export const getFileMetaTime = (filePath: PathLike) => {
 ...
 * @returns git时间字符串
 */
export interface GitTimestampSyncOptions {
    command: string[];
    cwd: string;
}

export const getGitTimestampSync = (command: GitTimestampSyncOptions["command"], cwd: GitTimestampSyncOptions["cwd"]): string => {
 ...
 */
export const getGitTimestamp = (filePath: string, createdDate: any, updatedDate: any) => {
